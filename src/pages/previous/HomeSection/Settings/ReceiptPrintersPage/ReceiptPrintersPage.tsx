    ...
    <div>
      <div>
        <h1 className="my-3 ml-5">
          <span className="text-3xl font-bold">Printers</span>{" "}
          <span className="font-light text-lg">Manage your Printers</span>
        </h1>
      </div>
...
export default ReceiptPrintersPage;
