...
import { TBody, THeader, Tbrow, Td, Th } from "@/components/previous/all/Table";
    ...
    <div>
      <div>
        <h1 className="my-3 ml-5">
          <span className="text-3xl font-bold">Barcode</span>{" "}
          <span className="font-light text-lg">
            Manage your barcode setting
          </span>
        </h1>
      </div>
      <div className="w-[98%] mx-auto  bg-slate-100 border-t-2 border-brand mb-10  pb-10 shadow-xl rounded">
        {/* top side area */}
          ...
          <div className="w-[98%] h-fit mx-auto mt-5">
            <Table>
              <THeader>
                ...
                <Th>Stiker Sheet Setting Description</Th>
              </THeader>
              <TBody>
                <Tbrow>
                  <Td></Td>
