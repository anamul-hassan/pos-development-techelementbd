    ...
    <div>
      <div>
        <h1 className="my-3 ml-4 ">
          <span className="text-3xl font-bold">Trial Balance </span>{" "}
      ...
      <div className="w-[98%] mx-auto  bg-slate-100 border-t-2 border-brand mb-10 flex pb-10 shadow-xl rounded">
        <div className="flex-1 w-full ">
          <div className="my-4 ml-2">
            <h2 className="bg-[#D2D6DE] py-2 pl-2">Trial Balance</h2>
            <div>
              <div className="flex justify-between mr-2 ml-2 font-bold">
                <h2> Supplier Due:</h2>
              </div>
        ...
        <div className="flex-1 w-full ">
          <div className="my-4 mr-2 border-l-[1px] border-brand ">
            <h2 className="bg-[#D2D6DE]  py-2 pl-2">Debit</h2>{" "}
        ...
        <div className="flex-1 w-full ">
          <div className="my-4 mr-2 border-l-[1px] border-brand ">
            <h2 className="bg-[#D2D6DE]  py-2 pl-2">Credit</h2>{" "}
            <div className="flex justify-between ml-2">
              <h2>৳ 0000.00</h2>
            </div>{" "}
            <div className="flex justify-between ml-2">
            ...
            <div className="flex justify-between ml-2">
              <h2 className="font-bold">৳ 0000.00</h2>
            </div>
          </div>
        </div>
      </div>
...
export default TrailBalancePage;
