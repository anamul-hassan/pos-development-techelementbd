    ...
    <div>
      <div>
        <h1 className="my-3 ml-2 lg:ml-[60px]">
          <span className="text-2xl font-bold">Add Staff Salary </span>{" "}
            ...
            <div className="mt-4 mr-5 flex">
              <div className="mr-5">
                ...
                <Input
                  ...
                  setValues={undefined} // setValues={setSearch}
                />
              </div>
              <div className="">
                <Button>+Add</Button>
...
export default AddStaffSalaryPage;
