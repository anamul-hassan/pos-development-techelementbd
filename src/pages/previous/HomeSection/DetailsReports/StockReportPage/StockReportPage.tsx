    ...
    <div>
      <div>
        <h1 className="my-3 ml-4 ">
          <span className="text-3xl font-bold">Stock Report</span>{" "}
        ...
        <div className="flex-1 w-full p-2 ">
          <div className="mt-5 mx-12">
            <div>
              ...
              <h2 className="text-2xl">৳ 2,001,943.60</h2>
            </div>
          </div>
        </div>
        <div className="flex-1 w-full p-2 ">
          <div className="mt-5 mx-12">
            <div>
              ...
              <h2 className="text-2xl">৳ 2,677,611.35</h2>
            </div>
          </div>
        </div>
        <div className="flex-1 w-full p-2 ">
          <div className="mt-5 mx-12">
            <div>
              ...
              <h2 className="text-3xl">৳ 675,667.75</h2>
            </div>
          </div>
        </div>
        <div className="flex-1 w-full p-2 ">
          <div className="mt-5 mx-12">
            <div>
              <h2>Profit Margin %</h2>
              <h2 className="text-2xl"> ৳ 52,320.00</h2>
            </div>
          </div>
        </div>
      </div>
