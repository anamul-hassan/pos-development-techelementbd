    ...
    <div>
      <div>
        <h1 className="my-3 ml-2 lg:ml-[60px]">
          <span className="text-3xl font-bold"> Purchase Return List</span>{" "}
        </h1>
      </div>
      {/* part 1 */}
      ...
      <div className="w-[94%] mx-auto bg-slate-100 pb-10 shadow-xl rounded">
        ...
        {/* tabel area */}
        <div>
          <div className="w-[96%] h-[40vh] mx-auto mt-5">
            <Table>
              <THeader>
                <Th>Action</Th>
                <Th>Date</Th>
...
export default ListReturnPurchasesPage;
