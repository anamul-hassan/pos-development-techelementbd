...
const AddPurchaseOrderPage = () => {
  ...
  return (
    <div>
      <div className="ml-14 mt-5 text-[30px] font-bold">Order Purchase</div>
      <div className="w-[94%] mx-auto mt-12 mb-10 bg-slate-100 pb-10 shadow-lg rounded border-t-2 border-brand">
        <div className="flex flex-col md:flex-row items-center justify-center w-[90%] mx-auto">
          ...
          {/* midel part2 */}
          {/* left part3  */}
          <div className="flex-1 w-full p-2 mt-7">
            <div className="my-4">
              <InputField
                isPassword={false}
                isIcon={false}
          ...
          <div className="flex-1 w-full  p-2">
            <div className="">
              <div className="my-4">
                <h2 className=" w-[200px] font-bold">1 Pay term:</h2>
                    ...
                    <div className="">
                      <div className="relative mt-1">
                        <select
                          {...register("gender")}
                          name="gender"
                          className=" border-[1px] border-brand appearance-none rounded-md w-full py-[7px] focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10"
                        >
              ...
              <div className="mb-5">
                <div className="flex items-center justify-center bg-grey-lighter mt-2">
                  <label className=" w-full py-[3px] text-brand  flex justify-center border-t-2 border-brand items-center  bg-white text-blue rounded-md tracking-wide uppercase  cursor-pointer hover:bg-blue hover:text-brand">
                    ...
                    <span className="mt-2 text-sm leading-normal ml-2">
                      Attach Document
                    </span>
                    <input
                      type="file"
      ...
      <div className="w-[94%] mx-auto bg-slate-100 pb-10 mb-20 shadow-lg rounded border-t-2 border-brand mt-5">
        <div className="w-2/3 mx-auto mt-9">
          <div className="lg:flex items-center">
            ...
            <div className="w-[200px] ml-2  border-[1px] border-brand flex justify-center rounded py-[7px]">
              Add New product
            </div>
          </div>{" "}
        </div>
          ...
          <div>
            <Table>
              <THeader>
                ...
                <Th>Uini Cost (Before Discount)</Th>
      ...
      <div className="w-[94%] mx-auto mt-12 mb-10 bg-slate-100 pb-10 shadow-lg rounded border-t-2 border-brand">
        <div className="flex flex-col md:flex-row items-center justify-center w-[90%] mx-auto">
          ...
          <div className="flex-1 w-full  p-2 mt-7">
            ...
            <div className="my-4">
              <div className="flex items-center justify-center bg-grey-lighter mt-2">
                <label className=" w-full py-[3px] text-brand rounded-md  flex justify-center border-t-2 border-brand items-center  bg-white text-blue  tracking-wide uppercase  cursor-pointer hover:bg-blue hover:text-brand">
                  <svg
                    className="w-8 h-8"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
